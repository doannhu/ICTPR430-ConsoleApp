...
namespace ICTPR430_ConsoleApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Drivers driver1 = new Drivers("1A2B3C", state1, "John", "Citizen", "0401234567", address1, 3);
            Drivers driver2 = new Drivers("111111", state2, "Aaron", "Sample", "0400000000", address2, 2);
            ...
            string[] myArray2 = {"licence: ", "1A2B3C", "name: ", "John", "Citizen","phone: ", "0401234567", "demerit point: ", "3" };
            ...
            truck1.UpdateKilometer(-1000);// expect 4000
            Console.WriteLine("For truck2: *****");
            truck2.UpdateKilometer(-1500);//expect 40500
            Console.WriteLine("For car1: *****");
            car1.ChangeColor("red");
            Console.WriteLine("For car2: *****");
            car2.ChangeColor("red");
            Console.WriteLine("For driver1: *****");
            driver1.UpdatePoint(2);//expect 5
            Console.WriteLine("For driver2: *****");
            driver2.UpdatePoint(-1);//expect 1
            ...
            //illegal change
            Console.WriteLine("For car1: *****");
            car1.UpdateKilometer(-6000);// expect a message of error in valid number
            Console.WriteLine("For truck1: *****");
            truck1.UpdateKilometer(-8000);// expect a message of error in valid number
            Console.WriteLine("For driver1: *****");
            driver1.UpdatePoint(5);// expect a message of Licence suspension is imminent
            driver1.UpdatePoint(4);//expect a message of Licence suspension
            Console.WriteLine("For driver2: *****");
            driver2.UpdatePoint(-10);// expect a message of invalid added demerit point
        }
    }
}
